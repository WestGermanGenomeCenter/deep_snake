...
rule run_deep:
    ...
    shell:
       ...
       nice deepconsensus run --subreads_to_ccs={params.mapped_bam} --ccs_bam={params.ccs_lq} --checkpoint={params.checkpoint_file} --output={output} --batch_zmws {params.zmw_batchsize} --cpus={threads} &>{params.logfile}
       """
